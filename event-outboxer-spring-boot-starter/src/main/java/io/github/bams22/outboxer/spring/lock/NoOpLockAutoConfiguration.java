...
/**
 * Default lock configuration — {@link EntityLocker#NOOP}. Kicks in when no handler declares {@code
 * extractLockKey} and the user has not configured a specific backend.
 */
@AutoConfiguration
