...
public abstract class AbstractWorkerRegistryContractTest {
     ...
     * stamp heartbeats with their own time source — the PostgreSQL adapter uses the database clock,
    ...
    @Test
    @DisplayName(
            "findDead() includes graceful-stop workers immediately, without waiting for the"
                    + " threshold")
