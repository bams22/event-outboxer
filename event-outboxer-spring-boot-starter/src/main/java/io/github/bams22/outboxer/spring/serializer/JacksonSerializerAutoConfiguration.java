...
/**
 * Autoconfiguration for the Jackson {@link EventSerializer}. Resolves the underlying {@link
 * ObjectMapper} in priority order (see ADR follow-up in the implementation plan, §7a):
 *
 * <ol>
