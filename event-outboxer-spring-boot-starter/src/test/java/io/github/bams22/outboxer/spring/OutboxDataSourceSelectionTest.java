...
class OutboxDataSourceSelectionTest {
    ...
    void advisoryLockerUsesQualifiedDataSource() {
        new ApplicationContextRunner()
                .withConfiguration(
                        AutoConfigurations.of(PostgresAdvisoryLockAutoConfiguration.class))
                .withUserConfiguration(QualifiedPlusPlainConfiguration.class)
    ...
    @Test
    @DisplayName(
            "engine pool warning resolves leniently: user locker + ambiguous DataSources still"
                    + " boots")
    void engineWarningToleratesAmbiguity() {
        ...
        new ApplicationContextRunner()
                ...
                .withUserConfiguration(
                        ...
                        TwoPlainDataSourcesConfiguration.class)
                .withBean("customLocker", EntityLocker.class, () -> custom)
    ...
    void analyzerRendersAmbiguityDiagnosis() {
        Throwable failure =
                new IllegalStateException(
                        "wrapped",
                        AmbiguousOutboxDataSourceException.noneQualified(List.of("dsA", "dsB")));
    ...
    static class StrictCaptureConfiguration {
        ...
        ResolvedHolder resolvedOutboxDataSource(
            ...
            return new ResolvedHolder(
                    OutboxDataSourceResolver.resolve(qualified, all, beanFactory));
        }
    }
     ...
     * returns a further stub, primitives return defaults. Nothing here ever reaches a real
     * database.
     */
